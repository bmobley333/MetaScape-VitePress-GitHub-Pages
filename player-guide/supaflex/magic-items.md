...
| 1 | P | **Rune Flask of Blackaxe Ale** | Drink; Heal self 1 Vit. |
...
| 1-Enc | P | **Whetstone of True Edge** | On use; next Atk with sharpened weapon Dmg+1. |
...
| 1-⚡ | P | **Blur Band** | Def/AR ✨+2; Atk ✨-1 Dmg ✨-2; 👁️^20 or 👣 3. |
| 1-Enc | F | **Bookmark of Memory** | Recall last page perfectly. |
| 1-Enc | M | **Boots of Springsteel** | Doubles jump height. |
| 1-Enc | P | **Bracers of Psionic Focus** | Activate focus; Atk+1 and Def+1 for 1 rnd. |
...
| 1-Enc | P | **Loaded Gambler’s Dice** | On use; reroll 1 failed Atk, Skill🎓, or Power roll. |
...
| 1-Enc | P | **Q-Bond Boots** | 💪+^Dif to bond to any surface including vertical but not ceiling; penalty MR(*0.5). |
...
| 3-Enc | A | **Railgun** | Dmg() reduces target AR (AR damaged until repaired); 💪+^Str to resist knockback. |
| 2-Enc | M | **RamJet Boots** | Jumps(**3); AoE Def/AR 🏃+2+. |
| 2-Enc | M | **RamJet Harness** | Triple jump distance; 👁️^Dif for landing; negates fall Dmg. |
...
| 1-Enc | A | **Smoke Bomb Satchel** | Throw Rng Short; creates 3sq smoke cloud; Dis(Atk, Def) 1Rnd. |
| 1-Enc | A | **Soap Bubble Wand** | Distract 1 foe; Magic✨ or target loses all actions this round. |
| 1-Enc | P | **Spearof Phalanx** | Melee hit; pushes target 1 sq; +1 Dmg with allied flanking. |
...
| 1-⚡ | P | **Chalice of Renewal** | Heal 2d6 Vit to all allies in 4sq. |
...
| 1-Enc | P | **Concealed Dagger** | Make 1 Atk this rnd with Advantage (one strike only). |
| 2-Enc | A | **Crescent [Weapon]** | Dodge+2 for 1 rnd. |
| 1-Enc | A | **Crossbow of the Alley** | Make 1 Ranged Atk; ignoring cover and any Atk Disadvantage. |
| 1-⚡ | A | **Crown of Beasts** | Summon 1d4+1 beast allies (Vit d✨+6 each) for encounter. |
...
| 1-Rnd | F | **Cyber-Legs, Speed** | High-mobility prosthetics; 👣+6; +1 Def/AR. |
...
| 1-⚡ | P | **Knight’s [Shield]** | Negate 1 Vit completely. |
...
| 1-Enc | P | **The Wall (Bronze Shield of the Fallen)** | Block+2 for 1 rnd. |
...
| --- | --- | --- | --- | --- |
| 1-Rnd | P | 1g | **Communicator** | Encrypted planetary and low-orbit transceiver. |
...
| 1-Enc | P | 6g | **EnviroTent** | Deploy shelter; supports 3 occupants for 7 days; climate insulated; emergency transponder. |
| 2-Enc | P | 2g | **First Aid Pack** | 1st Deg Wnds if new; stops bleeding. |
| 2-Enc | P | 5g | **FusionSplicer** | Splices wires and repairs armor bonds. |
| 1-Rnd | P | 1g | **GlowTorch** | Rng Medium; 90° cone of visible/IR light. |
...
| 2-Enc | P | 8g | **HoloCaster** | Rng Medium; projects duplicate decoy image. |
...
| 2-Enc | M | 5g | **Personal Scanner** | Handheld scanner Rng Medium. Pose question to GM; answer limited to 1 word. |
...
| 1-⚡ | P | 18g | **QuantumChef** | 1-inch cube expands to cookware and thermal cups; stores 1 week rations. |